...
const letter = {
  ...
  visible: {
    ...
    return ( 
        <motion.h2 initial="hidden" animate="visible" variants={sentence} className={`${montserrat.className} w-[50%] sm:text-xl md:w-[40%] md:text-2xl lg:w-[35%] text-white px-5 sm:p-5 font-semibold`}> 
